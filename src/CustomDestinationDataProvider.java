...
public class CustomDestinationDataProvider {
	...
	public static final String ABAP_SYSTEM = "ABAP_SYSTEM";
    ...
    public static void main(String[] args) {
        ...
        memoryProvider.changeProperties(ABAP_SYSTEM, getDestinationPropertiesFromUI());

        // ... work with it
        executeCalls(ABAP_SYSTEM);
    ...
    private static Properties getDestinationPropertiesFromUI() {
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "host.url");
